/**
 * Auto-generated smoke test for vendored app `vendor/examples/react/i18n-paraglide`.
 * Imports the generated route tree and runs shared harness assertions.
 */
import { describe } from 'vitest';

import { routeTree } from '../../../../../vendor/examples/react/i18n-paraglide/src/routeTree.gen.ts';
